...
<html>
    <head>
        ...
        <style>
            ...
            table#board_table, table#server_table, table#user_table, table#session_table{
                width: 100%;
                text-align: center;
            }
            div#board_rb {
    ...
    <body>
        ...
        <div id="session">
            <div id="session_left">
                ...
                <div id='admin_user_list_result'>

                </div>
            </div>
            <div id="session_middle">
                <h3 style='text-align:center'>현재 접속자</h3>
                <div id='admin_session_list_result'>

                </div>

            </div>
            <div id="session_right">
                <h3 style='text-align:center'>차단 IP 목록</h3>
            </div>
        </div>
        ...
        <div id="board">
            <div id="board_left">
                ...
                <div id="admin_board_list_result">
        ...
        <div id="server">
            <div id="server_left">
                ...
                <div id="admin_server_list_result">
