...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $.ajax({
                    type:"GET",
                    url: "/getAjax.php?m=board_view&board_num=" + board_num,
                    dataType: 'json',
            ...
            $(document).on("click", ".btn_delete", function(){
              ...
              $.ajax({
                  type:"GET",
                  url: "/getAjax.php?m=board_delete&board_num="+board_num+"&board_pw="+name_value,
                  success : function(data){
    ...
    <body>
        ...
        <div data-role="content">
            ...
            <button type="button" name="button" id="btn_del" class="btn_delete" >삭제</button>
