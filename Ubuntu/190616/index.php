    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                var car_ip = '<?= $car_ip ?>';
                var stream_src = "http://"+car_ip+":8080/stream/video.mjpeg";
                $('#stream').attr('src', stream_src);
            });
        </script>
    </head>
    <body>
        ...
        <div data-role="content">
            ...
            <div style='display:inline-block; width:100%; height:auto; text-align:center;'>
                <img id='stream' style='width:100%; height:auto;' src=''>
            </div>
            <div id='div_go'>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function(){
            ...
            if ("WebSocket" in window) {
                var car_ip = '<?= $car_ip ?>';
                ws = new WebSocket("ws://"+car_ip+":9999");
                ws.onopen = function() {
