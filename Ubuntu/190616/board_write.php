...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $("#btn_board_write").click(function(){
                    if(flag_board_title && flag_board_user_id && flag_board_pw && flag_board_content){
                        var boardWriteData = $('#form_board_write').serialize();
                        $.ajax({
                            type:"POST",
                            url: "/postAjax.php",
                            data: boardWriteData,
            ...
            function checkBoardUserID(event) {
                ...
                $.ajax({
                    type:"GET",
                    url: "/getAjax.php?m=checkId&user_id=" + board_user_id,
                    success : function(data){
                        var result = data.replace(/\n/g, "")
                        if (result == "N"){
    ...
    <body>
        ...
        <div data-role="content">
            <form id="form_board_write">
                <input type="hidden" name="typeAjax" value="board_write">
